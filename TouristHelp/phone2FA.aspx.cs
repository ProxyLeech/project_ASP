...
{
    public partial class phone2FA : System.Web.UI.Page
    {
        ...
        protected void verifyPhone(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                else
                {
                    ...
                    if (TouristDAO.Phone2FAValidation(code) == true)
                    {
        ...
        {
            string code = twofaphoneTB.Text;
            if (TouristDAO.Phone2FAValidation(code) == false)
            {
                args.IsValid = false;
            }
