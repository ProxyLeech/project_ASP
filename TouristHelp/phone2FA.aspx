<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="phone2FA.aspx.cs" Inherits="TouristHelp.phone2FA" %>
			...
			<div class="d-flex justify-content-center h-100">
				<div class="card">
					<div class="card-header">
						<br>
						<h3 class="text-center"> Phone Verification 2FA Shield</h3>
...
<%--								<button type="submit" formaction="/user/indexVerified"  style="margin-top:20%; background-color:lightgreen" onclick="" class="btn float-right login_btn">Confirm</button>--%>
		    <asp:Button ID="phone2FA_Btn" runat="server" Text="Confirm" OnClick="verifyPhone" style="left:100%;" class="btn float-right login_btn"  BackColor="#66FF33" />
